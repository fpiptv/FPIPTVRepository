...
SOURCES = [{"title": "BassFox ", "url": "https://dl.dropbox.com/s/93hingfl7rlx34r/bassfox.xml", "fanart": "https://dl.dropbox.com/s/038p1oo392w3mor/fanart.jpg", "genre": "Tv Live", "date": "10.07.2015", "credits": "BassFox", "thumbnail": "http://i2.minus.com/j5HeempSScdjg.png"}]

# https://dl.dropbox.com/s/038p1oo392w3mor/fanart.jpg
# http://i2.minus.com/j5HeempSScdjg.png
...
def getSources():
        if os.path.exists(favorites) == True:
            ...
            if FAV == "[]":
                ...
                addDir('[COLOR cyan][B]- FAVORITES CHANNEL BASSFOX [/COLOR][/B]','url',4,os.path.join(home, 'resources', 'favorite.png'),FANART,'','','','')
                addDir('','',100,'',FANART,'','','','')
...
def search(site_name,search_term=None):
    ...
    if 'youtube' in site_name:
        ...
        if res == 'True':
            ...
            xbmc.executebuiltin("XBMC.Notification(BassFox,No IMDB match found ,7000,"+icon+")")
